...
vim.keymap.set("n", "gd", function()
	tb.lsp_definitions()
end, { silent = true, desc = "LSP: przejdź do definicji" })
vim.keymap.set("n", "gi", function()
	tb.lsp_implementations()
end, { silent = true, desc = "LSP: przejdź do implementacji" })
vim.keymap.set("n", "gr", function()
	tb.lsp_references()
end, { silent = true, desc = "LSP: pokaż referencje" })
...
vim.keymap.set(
	...
	{ silent = true, desc = "Przeszukaj pliki (live grep)" }
)
